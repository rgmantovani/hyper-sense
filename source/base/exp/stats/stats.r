...
mcnemar = function(alg1, alg2){

}

# > x <− matrix(c(4, 11, 2, 40), nrow=2, ncol=2, byrow=TRUE) >x
# ￼￼[ ,1] [ ,2] [1 ,] 4 11 [2,] 2 40
# > mcnemar.test(x, correct=TRUE) McNemar’ s Chi−squared test with
# continuity
# p−value =
# correction
# 0.0265
# data: x
# McNemar’ s chi−squared = 4.9231 , df
